...
const EditPostPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const getPost = await axios.get(`${process.env.REACT_APP_BASE_URL}/posts/id/${id}`, {
        headers: { Authorization: `Bearer ${auth.token}` },
      });

      const { title, body, category } = getPost.data.result.posts;
      setTitle(title);
      setBody(body);
  ...
  const submitHandler = async (e) => {
    ...
    await axios
      .post(`${process.env.REACT_APP_BASE_URL}/posts/upd/${id}`, data, { headers: { Authorization: `Bearer ${auth.token}` } })
      .then(() => {
  ...
  const deleteHandler = async (e) => {
    ...
    await axios
      .post(`${process.env.REACT_APP_BASE_URL}/posts/del/${id}`, null, { headers: { Authorization: `Bearer ${auth.token}` } })
      .then(() => {
